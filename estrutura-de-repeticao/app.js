...
do{
    console.log(`Posição ${controladorDoWhile
    } valor lido = ${listaArgumentos[controladorDoWhile
    ]}`)
    controladorDoWhile++
...
for(const argumento of listaArgumentos){
    console.log(`Posição ${controladorForOf
    } valor lido = ${listaArgumentos[argumento
    ]}`)
    controladorForOf++
}